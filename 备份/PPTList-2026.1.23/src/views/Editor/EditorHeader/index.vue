 ...
 <span class="handler-item pptfont ppt-fengexian gray-200"/>
    ...
    <div class="right">
       <div class="flex align-center mr-10">
        ...
        <div class="btn button-ppt cur">标准版</div>
        <div class="btn button-ppt mr-20">高级版</div>
        <Button type="primary" size="small"  v-tooltip="'导出'" @click="setDialogForExport('pptx')">
          <div class="flex flex-center pl-10 pr-10">
